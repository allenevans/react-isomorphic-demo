...
(function () {
    var bootstrap = function bootstrap() {
        new _ClientJs2["default"]();
        (0, _page2["default"])(window.location.pathname + window.location.search);
    };
...
},{"./Client.js":2,"page":4}],2:[function(require,module,exports){
/**
 * Created by allen on 02/06/2015.
 */
...
var Client = (function () {
    function Client() {
        ...
        window.onpopstate = function () {
            return _this.render(window.location.pathname + window.location.search);
        };
    }
    ...
    _createClass(Client, [{
        ...
        value: function render(url) {
            var mountElement = document.getElementById("react-mount");
...
},{"_process":3,"path-to-regexp":5}],5:[function(require,module,exports){
